...
const D = {
  ...
  primary:     '#25584B',
  primaryDim:  '#EAF2EF',
  primaryGlow: 'rgba(37,88,75,0.18)',
  success:     '#2E8B57',
  successDim:  'rgba(46,139,87,0.10)',
  info:        '#25584B',
  infoDim:     '#EAF2EF',
  purple:      '#7C5CBA',
  purpleDim:   'rgba(124,92,186,0.10)',
  warning:     '#D99A2B',
  warningDim:  'rgba(217,154,43,0.10)',
  danger:      '#D64C4C',
  dangerDim:   'rgba(214,76,76,0.10)',
  text:        '#1F2328',
  textSec:     '#3A4149',
  textMuted:   '#68737A',
  divider:     '#EDE9E4',
